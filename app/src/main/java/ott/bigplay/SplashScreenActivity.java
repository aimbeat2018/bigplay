...
import ott.bigplay.network.apis.ConfigurationApi;
import ott.bigplay.network.model.config.ApkUpdateInfo;
import ott.bigplay.network.model.config.Configuration;
...
//added splash video
            Uri video = Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.bigplay);
            myvideoview.setVideoURI(video);
