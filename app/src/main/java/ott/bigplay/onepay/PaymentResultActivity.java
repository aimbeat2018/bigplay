...
import ott.bigplay.AppConfig;
import ott.bigplay.FinalPaymentActivity;
import ott.bigplay.MainActivity;
import ott.bigplay.OneUPIPaymentActivity;
import ott.bigplay.R;
...
import ott.bigplay.network.model.Package;
...
ProgressBar progressBar;
    ...
    private ott.bigplay.database.DatabaseHelper databaseHelper;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            SharedPreferences sharedPreferences = PaymentResultActivity.this.getSharedPreferences(ott.bigplay.utils.Constants.USER_AGE, MODE_PRIVATE);
...
//        Toolbar toolbar = findViewById(R.id.toolbar);
        ...
        if (getIntent() != null) {
            ...
            databaseHelper = new ott.bigplay.database.DatabaseHelper(this);
        }
        ...
        call.enqueue(new Callback<ActiveStatus>() {
            ...
            public void onResponse(Call<ActiveStatus> call, retrofit2.Response<ActiveStatus> response) {
                if (response.code() == 200) {
                    ...
                    ott.bigplay.database.DatabaseHelper db = new ott.bigplay.database.DatabaseHelper(getApplicationContext());
