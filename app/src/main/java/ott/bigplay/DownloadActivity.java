...
import ott.bigplay.adapters.DownloadHistoryAdapter;
import ott.bigplay.adapters.DownloadedVideoListAdapter;
import ott.bigplay.adapters.FileDownloadingAdapter;
import ott.bigplay.constant.AppUtil;
...
import ott.bigplay.models.Work;
import ott.bigplay.nav_fragments.DownloadNewFragment;
...
//                activity.getSupportFragmentManager().beginTransaction().replace(R.id.Container, myFragment).addToBackStack(null).commit();
                ...
                ott.bigplay.database.DatabaseHelper offlineDatabaseHelper1 = new DatabaseHelper(DownloadActivity.this);
