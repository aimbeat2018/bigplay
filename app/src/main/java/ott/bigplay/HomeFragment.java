...
import ott.bigplay.adapters.ContinueWatchingAdapter;
import ott.bigplay.adapters.CountryAdapter;
import ott.bigplay.adapters.GenreAdapter;
import ott.bigplay.adapters.GenreHomeAdapter;
import ott.bigplay.adapters.HomeGoldPageAdapter;
import ott.bigplay.adapters.HomePageAdapter;
import ott.bigplay.adapters.LiveTvHomeAdapter;
import ott.bigplay.adapters.PopularStarAdapter;
import ott.bigplay.adapters.SliderListAdapter;
...
import ott.bigplay.database.homeContent.HomeContentViewModel;
import ott.bigplay.models.CommonModels;
import ott.bigplay.models.GenreModel;
import ott.bigplay.models.GoldModel;
import ott.bigplay.models.home_content.AllCountry;
import ott.bigplay.models.home_content.AllGenre;
import ott.bigplay.models.home_content.FeaturedTvChannel;
import ott.bigplay.models.home_content.FeaturesGenreAndMovie;
import ott.bigplay.models.home_content.HomeContent;
import ott.bigplay.models.home_content.LatestTvseries;
import ott.bigplay.models.home_content.PopularMovie;
import ott.bigplay.models.home_content.PopularStars;
import ott.bigplay.models.home_content.Slide;
import ott.bigplay.models.home_content.Slider;
import ott.bigplay.models.home_content.Video;
import ott.bigplay.network.RetrofitClient;
import ott.bigplay.network.apis.HomeContentApi;
import ott.bigplay.network.apis.LoginApi;
import ott.bigplay.network.apis.OrderEntryResponse;
import ott.bigplay.network.apis.OrderstatusResponse;
import ott.bigplay.network.apis.PassResetApi;
import ott.bigplay.network.apis.UserDataApi;
import ott.bigplay.network.model.User;
import ott.bigplay.utils.Constants;
import ott.bigplay.utils.NetworkInst;
...
//        cViewPager = view.findViewById(R.id.c_viewPager);
        ...
        fblink.setOnClickListener(v -> {
          ...
          //  i.setData(Uri.parse("https://www.facebook.com/profile.php?id=100090905424999"));
            i.setData(Uri.parse("https://www.facebook.com/profile.php?id=61552855388330"));
      ...
      /*  twitterlink.setOnClickListener(v -> {
        ...
        instalink.setOnClickListener(v -> {
           ...
           // i.setData(Uri.parse("https://instagram.com/besharamsapp?igshid=NGVhN2U2NjQ0Yg=="));
            i.setData(Uri.parse("https://www.instagram.com/bigplay_app/"));
            getContext().startActivity(i);
