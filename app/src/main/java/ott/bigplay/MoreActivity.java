...
import ott.bigplay.adapters.NavigationAdapter;
import ott.bigplay.database.DatabaseHelper;
import ott.bigplay.models.NavigationModel;
import ott.bigplay.more.ApplyPromoCodeActivity;
import ott.bigplay.more.HelpActivity;
...
import ott.bigplay.network.model.ActiveSubscription;
import ott.bigplay.network.model.SubscriptionHistory;
...
//                mDrawerLayout.closeDrawers();
    ...
    public void onPrivacyClick(View view) {
      ...
      //  intent.putExtra("url", "https://ox9.in/ox9_backoffice/rest_api/privacy-policy.php");
        intent.putExtra("url", "https://ox9.in/privacy-policy.php");
    ...
    public void onRefundClick(View view) {
        ...
        intent.putExtra("url", "https://ox9.in/refund-policy.php");
