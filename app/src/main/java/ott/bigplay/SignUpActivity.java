...
import ott.bigplay.constant.Constant;
import ott.bigplay.database.DatabaseHelper;
import ott.bigplay.network.RetrofitClient;
import ott.bigplay.network.apis.FirebaseAuthApi;
import ott.bigplay.network.apis.SignUpApi;
...
*/
                ...
                i.setData(Uri.parse("https://ox9.in/terms-condition.php/"));
                startActivity(i);
