...
std::string SERVER_URL = "https://ox9.in/ox9_backoffice/rest_api/";
...
Java_ott_bigplay_AppConfig_getApiServerUrl(
        JNIEnv *env,
        jclass clazz) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_ott_bigplay_AppConfig_getApiKey(
        JNIEnv *env,
        jclass clazz) {
...
extern "C" JNIEXPORT jstring JNICALL
Java_ott_bigplay_AppConfig_getPurchaseCode(
        JNIEnv *env,
        jclass clazz) {
